...
| 09 | Global SPEI/SPI / meteo archive (clip source) | External climate archives on the author’s local machine only (never in git, never a repo artifact) | ~50 GB | **No** (external only) | none (set via `CH09_METEO_GLOBAL_DIR`; not in this repo) |
